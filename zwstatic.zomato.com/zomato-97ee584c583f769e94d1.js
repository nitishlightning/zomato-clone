    ...
    [8312], {
        dg7M: (C, e, t) => {
            ...
            const g = (C, e) => {
                    ...
                    if (t.setAttribute("id", "auth-login-ui"), t.setAttribute("src", e), t.setAttribute("sandbox", "allow-top-navigation allow-scripts allow-popups allow-forms allow-same-origin"), t.style.alignItems = "center", t.style.position = "fixed", m = document.createElement("div"), f = t, C === p) {
                        ...
                        n.style.width = "100%", n.style.height = "100%", n.style.position = "absolute", n.style.opacity = "0.8", n.style.top = "0px", n.style.backgroundColor = "black", n.onclick = h, m.style.width = "100%", m.style.height = "100%", m.style.border = "100%", m.style.position = "fixed", m.style.top = 0, m.appendChild(n)
                    } else t.style.width = "0", t.style.height = "0", t.style.visibility = "hidden";
                    m.appendChild(f), document.body.appendChild(m)
                },
                L = () => {
                    void 0 !== m && (m.remove(), m = void 0), void 0 !== f.close && f.close()
                },
                b = C => {
                    f = window.open(C);
                    let e = setInterval((function() {
                        f.closed && (clearInterval(e), h())
                    }), 50)
                };
            class v {
                constructor() {
                    if (v._instance) return v._instance;
                    v._instance = this, this.cookie_domain = process.env.REACT_APP_COOKIE_DOMAIN || process.env.NEXT_PUBLIC_COOKIE_DOMAIN, this.accounts_domain = process.env.REACT_APP_ACCOUNTS_DOMAIN || process.env.NEXT_PUBLIC_ACCOUNTS_DOMAIN, this.google_cid = "442739719837.apps.googleusercontent.com", this.accounts_data = {
                        LOGIN_TYPE: "login",
                        LOGIN_METHODS: ["google", "email", "phone"]
                    }, this.auth_init_identifier = ""
                }
                setOAuthScreen(C) {
                    this.oauth_screen = C
                }
                ...
                setAccountsData(C, e) {
                    let t = ["google", "email", "phone"];
                    if (["https://external.zomans.com"].includes(window.location.origin) && t.push("akamai"), "LOGIN_METHODS" == C) {
                ...
                setAuthInitIdentifier(C) {
                    this.auth_init_identifier = C || ""
                }
            }
            const w = function(C) {
                    var e = new U,
                ...
                _ = C => `; ${document.cookie}`.split(`; ${C}=`).pop().split(";").shift();
            ...
            function y(C) {
                var e = (new v).accounts_domain + "/consent";
            ...
            function k(C, e, t) {
                ...
                var o = new U,
                    a = (new v).accounts_domain + "/callback";
                fetch(a, {
                    method: "POST",
                    credentials: "include",
                    body: n
                        ...
                        if (C.data.opaque_token) {
                            ...
                            e.append("token", C.data.opaque_token), o.redirect_url && function(C) {
                                ...
                                try {
                                    ...
                                    if (!/^(https|http):\/\/(.+)?(\.eks\.zdev\.net|\.zdev\.net|\.zomans\.com|\.zomatoweather\.com|\.weatherforindia\.com|\.zomatoxtreme\.com|\.liveweather\.co\.in|\.weatherunion\.com)$/i.test(e)) return !1
                                } catch (C) {
                                    return !1
                                }
                                return !0
                                ...
                                headers: {
                                    ...
                                    "x-zomato-csrf-token": _("__Host-csrft")
                                }
                            }).then((C => C.json())).then((function(C) {
                                C.status && Z()
                            })).catch((C => {
                ...
                return new Promise((async (t, a) => {
                    let i = await async function() {
                        ...
                        var n = E(),
                            ...
                            a = await P(o),
                            i = new URL(t);
                        return i.searchParams.append("code_challenge", a), i.searchParams.append("code_challenge_method", "S256"), i.searchParams.append("client_id", e.client_id), i.searchParams.append("redirect_uri", C.accounts_domain + "/zoauth/callback"), i.searchParams.append("scope", e.scope), i.searchParams.append("state", n), i.searchParams.append("response_type", e.response_type), C.setAccountsData("zxcv", o), C.setAccountsData("purl", top.window.location.origin), C.setAccountsData("cid", e.client_id), C.setAccountsData("curl", e.redirect_url), w(e.client_id), i.href
                    }();
                    n = t,
                        function(C) {
                            o = C
                        }(a), C === d ? b(i) : C === l && g(e === c ? p : u, i)
                }))
            }
            var T = !1;
            ...
            function D(C) {
                var e = new v;
                e.oauth_screen == l ? document.getElementById("auth-login-ui").contentWindow.postMessage(C, e.accounts_domain) : f.postMessage(C, e.accounts_domain)
            }
            ...
            function H(C) {
                if (C.data && C.data.ev) {
                    ...
                    if (C.origin === e.accounts_domain) switch (z(), t.ev) {
                        ...
                        case "loggedOut":
                            ...
                            break;
                        case "errorFound":
                            L(), void 0 !== i ? i("not able to logout") : void 0 !== s ? s("not able to refresh") : void 0 !== o && o("not able to signin"), T && (T = !1);
                            break;
                        ...
                        case "completeCallback":
                            k(t.data.code, t.data.state, t.data.scope);
                            break;
            ...
            const S = () => {
                ...
                z = () => {
                    D({
                        ev: "authInitIdentifier",
                        auth_init_identifier: (new v).auth_init_identifier
                    })
                };
            ...
            const j = ({
                ...
                var e = new U,
                    t = new v;
                return t.setIdToken(C), t.setOAuthScreen(l), O(l, "one_tap", e.client_id, e.scope, e.response_type)
            };

            function V() {
                return new Promise(((C, e) => {
                    var t = new U,
                        n = (new v).accounts_domain + "/token/refresh";
            ...
            function R(C) {
                var e = _("ttaz");
                if (e && 1e3 * parseInt(e) - Date.now() < 36e5) return V()
            }
            const W = 2,
                B = 4;
            ...
            class U {
                constructor(C = {}) {
                    if (U._instance) return U._instance;
                    U._instance = this, this.client_id = C.client_id, this.scope = C.scope || "offline", this.redirect_url = C.redirect_url || "", this.response_type = "code", this.refresh_enable = C.refresh_enable || !0, this.auth_init_identifier = C.auth_init_identifier || "";
                    var e, t = new v;
                    void 0 !== C.login_methods && t.setAccountsData("LOGIN_METHODS", C.login_methods), this.logout_url = C.logout_url || "", !0 === C.enable_one_tap && function() {
                        ...
                        C.setAttribute("src", "https://accounts.google.com/gsi/client"), C.onload = F, document.body.appendChild(C)
                    }(), void 0 !== C.theme && t.setTheme(C.theme), void 0 !== C.auth_init_identifier && t.setAuthInitIdentifier(C.auth_init_identifier), window.addEventListener("message", H, !1), !0 === C.custom && async function() {
                        var C = new U;
                        (new v).setOAuthScreen(l), O(l, "custom_login", C.client_id, C.scope, C.response_type)
                    }(this.client_id, this.scope, this.response_type), !0 === this.auto_refresh && (R(this.client_id), setInterval((() => R(this.client_id)), 18e5)), (e = _("lme")) && "1" === e && this.migrate().then(void(document.cookie = "lme=; Path=/;Domain=.zdev.net; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"))
                }
                validate() {
                ...
                login(C = l, e = c) {
                    var t = new v;
                    return [l, d].includes(C) && t.setOAuthScreen(C), O(C, e)
                }
                logout() {
                    return new Promise(((C, e) => {
                        var t = new U,
                            n = (new v).accounts_domain + "/signout";
                        const o = new FormData;
                        o.append("cid", t.client_id), fetch(n, {
                            ...
                            t.status ? (x(), C(t.message)) : e(t.message)
                        })).catch((function(C) {
                            e(C)
                        }))
                    }))
                ...
                migrate() {
                    return C = new U, e = new v, T = !0, e.setOAuthScreen(l), O(l, "migration_flow", C.client_id, C.scope, C.response_type);
                    var C, e
                }
                initiatePhoneLogin(C, e, t, n) {
                    return function(C, e, t, n) {
                        return new Promise(((o, a) => {
                            var i = new v;
                            let r = i.accounts_domain + "/login/phone";
                            const s = new FormData;
                            s.append("country_id", C), s.append("number", e), s.append("lc", i.login_challenge), s.append("type", "initiate"), s.append("verification_type", t || "sms"), s.append("message_uuid", n || ""), fetch(r, {
                                method: "POST",
                                body: s,
                                credentials: "include"
                ...
                verifyPhoneLogin(C, e, t) {
                    return function(C, e, t) {
                        return new Promise(((n, o) => {
                            var a = new v;
                            let i = a.accounts_domain + "/login/phone";
                            const r = new FormData;
                            r.append("country_id", C), r.append("number", e), r.append("lc", a.login_challenge), r.append("type", "verify"), r.append("otp", t), fetch(i, {
                                method: "POST",
                                body: r,
                                credentials: "include"
                            }).then((C => C.json())).then((C => {
                                C.status ? ([W, B].includes(C.login_case) ? N(C.redirect_to) : a.setPnlHash(C.hash), n(C)) : o(C)
                            }))
                        }))
                    }(C, e, t)
                }
                signupPhoneLogin(C, e) {
                    return function(C, e) {
                        return new Promise(((t, n) => {
                            ...
                            i.append("hash", o.pnl_hash), i.append("lc", o.login_challenge), i.append("type", "create_user"), i.append("name", C), i.append("email", e), fetch(a, {
                                method: "POST",
                                body: i,
                                credentials: "include"
                            }).then((C => C.json())).then((C => {
                                C.status ? (N(C.redirect_to), t(C)) : n(C)
                            }))
                        }))
                    }(C, e)
                }
                ...
                verifyEmailLogin(C, e) {
                    return function(C, e) {
                        return new Promise(((t, n) => {
                            ...
                            const i = new FormData;
                            i.append("email", C), i.append("lc", o.login_challenge), i.append("type", "verify"), i.append("otp", e), fetch(a, {
                                method: "POST",
                                body: i,
                                credentials: "include"
                            }).then((C => C.json())).then((C => {
                ...
                initiateEmailSignup(C, e) {
                    return function(C, e) {
                        return new Promise(((t, n) => {
                            ...
                            let a = o.accounts_domain + "/login/email";
                            const i = new FormData;
                            i.append("name", e), i.append("email", C), i.append("lc", o.login_challenge), i.append("type", "signup"), fetch(a, {
                                method: "POST",
                                body: i,
                                credentials: "include"
                            }).then((C => C.json())).then((C => {
                    ...
                    return function(C) {
                        return new Promise(((e, t) => {
                            ...
                            a.append("hash", n.pnl_hash), a.append("lc", n.login_challenge), a.append("type", "verify_otp_link"), a.append("otp", C), fetch(o, {
                                ...
                                C.status ? (N(C.redirect_to), e(C)) : t(C)
                            }))
                        }))
                    }(C)
                }
            ...
            const G = function(C) {
                var e;
                if (null != (e = C.client_id) && 0 !== e.length) return new U(C)
            }
        },
        Itp7: (C, e, t) => {
            t.d(e, {
...
`, A = n.forwardRef((({
                ...
                ref: t
            }, n.createElement(P, null, n.createElement(O, null, "UP TO"), n.createElement(T, null, `${C}% off`)), n.createElement(D, null, e), n.createElement(H, null, n.createElement(m, {
                size: 30
            })))));
            I = A;
            var I, z = t("AkOy");
            const F = "image",
                ...
                R = ({
                    ...
                    let n = !1;
                    return (0, z.default)(V.find((C => e === C))) && (n = !0), C ? Array.isArray(C) ? C.reduce(((C, o) => {
                        let a = o;
            ...
            const B = ({
                    ...
                    switch ((0, n.useEffect)((() => {
                        r && r.current && !a && (i ? r.current.pause() : r.current.play())
                    }), [r, i, a]), e) {
                        case F:
                            {
                                const {
...
`, Y = ({
            ...
            const CC = "nocurve",
                ...
                nC = "large",
                oC = [CC, eC, tC, nC],
                aC = (C, e = 1) => C < -1 * e ? "" : C > -1 * e && C < 1 * e ? CC : C < 13.5 * e ? eC : C < 16 * e ? tC : nC,
                iC = (C, e) => {
                ...
                rC = (C, e, t, n = 1) => {
                    ...
                    if (t < o.length - 1) {
                        const C = e.getBoundingClientRect().width,
                            ...
                            i = aC(a - C, n);
                        iC("bottom", e), i ? (e.classList.add("bottom-curve"), e.classList.add(`b${i}`), e.textButificationData = {
                            bottomCurve: {
                                isEnabled: !0,
                                curveSize: i
                            }
                    ...
                    } else iC("bottom", e), e.textButificationData = {
                        bottomCurve: {
                            isEnabled: !1,
                            curveSize: ""
                        }
                    ...
                    if (t > 0) {
                        const C = e.getBoundingClientRect().width,
                            a = o[t - 1].getBoundingClientRect().width,
                            i = aC(a - C, n);
                        iC("top", e), i ? (e.classList.add("top-curve"), e.classList.add(`t${i}`), e.textButificationData = {
                            topCurve: {
                                isEnabled: !0,
                                curveSize: i
                            }
                    ...
                    } else iC("top", e), e.textButificationData = {
                        topCurve: {
                            isEnabled: !1,
                            curveSize: ""
                        }
...
`;
            ...
            function SC() {
                return SC = Object.assign || function(C) {
                    for (var e = 1; e < arguments.length; e++) {
                        var t = arguments[e];
                        for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (C[n] = t[n])
                    }
            ...
            const AC = ({
                    ...
                    }), [c, C, e, t, o, a, i, r]), n.createElement(DC, {
                        ref: c,
                        transform: e,
                        bg: a,
                        color: i
                    }, l.map(((C, e) => n.createElement(HC, SC({
                        key: e
                    }, s, {
                        bg: a,
                        color: i
...
`,
                BC = ({
                    ...
                    onMuteClick: e,
                    ...t
                }) => n.createElement(WC, RC({
                    onClick: e
                }, t), C ? n.createElement(VC.default, {
                    color: r.white,
                    size: 22
                }) : n.createElement(jC.default, {
                    color: r.white,
                    size: 22
                })),
                NC = o.css `
...
`);
            ...
            function qC() {
                return qC = Object.assign || function(C) {
                    for (var e = 1; e < arguments.length; e++) {
                        var t = arguments[e];
                        for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (C[n] = t[n])
                    }
            ...
            const KC = ({
                    ...
                    const r = (C => {
                            ...
                            return !(0, z.default)(t) && t ? .metaData ? .url ? o = { ...t,
                                backgroundType: F
                            } : !(0, z.default)(e) && e ? .metaData ? .url && (o = { ...e,
                                backgroundType: j
                            }), {
                                background: o,
                                elements: n
                    ...
                    })), Object.keys(t).map((e => n.createElement(q, qC({
                        key: e
                    }, t[e], {
                        storyViewerRef: b,
                        viewerFrameWidthInPx: C
                    })))), (s ? .backgroundType ? ? "") === j && !i && n.createElement(GC, {
                        isMuted: l,
                        onMuteClick: () => {
                            m((C => !C))
                        }
